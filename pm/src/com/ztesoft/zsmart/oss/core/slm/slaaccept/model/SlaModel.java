package com.ztesoft.zsmart.oss.core.slm.slaaccept.model;
 ...
 * @since V7.0<br>
 * @see com.ztesoft.zsmart.oss.core.slm.slaaccept.model <br>
 */
public class SlaModel {
    ...
    public void init(DynamicDict dict) throws BaseAppException {
        setSlaInstId((String) dict.getValueByName("SLA_INSTID", ""));
        ...
        setSlaAmount((String) dict.getValueByName("SLA_AMOUNT", ""));
        setParticipantNo(dict.getString("PARTICIPANT_NO"));
        setParticipantName(dict.getString("PARTICIPANT_NAME"));
        //剔除日期
