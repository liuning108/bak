define([
  ...
  var GBar = GRoot.extend({
    initElement: function() {
      ...
      this.doms['gb'] = paper.rect(x - 25, y - 140, 532, 377).attr({
        'fill': '#36b0c8',
        'fill-opacity': 0,
        'stroke': '#595959',
        'stroke-width': 5,
      ...
      this.doms['label_1'] = paper.text(x + 184, y + 195, '正常').attr({
        'fill': '#ffffff',
        'font-size': 18,
        'font-family': '微软雅黑',
        'font-weight': 'bold'
      ...
      this.doms['label_2'] = paper.text(x + 184 + 65, y + 195, '紧急').attr({
        'fill': '#ffffff',
        'font-size': 18,
        'font-family': '微软雅黑',
        'font-weight': 'bold'
      ...
      this.doms['label_3'] = paper.text(x + 184 + 65 + 65, y + 195, '危险').attr({
        'fill': '#ffffff',
        'font-size': 18,
        'font-family': '微软雅黑',
        'font-weight': 'bold'
