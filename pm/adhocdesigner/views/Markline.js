 ...
 */
define([
        'text!oss_core/pm/adhocdesigner/templates/Markline.html'
    ],
    function(mainTpl) {
    return portal.BaseView.extend({
        ...
        afterRender: function () {
            //
            this.$('#ad-markline-plus').on("click", this.wrap(function(){
                this.addMarkline();
            }));
            this.$('#ad-markline-minus').on("click", this.wrap(function(){
                this.delMarkline();
            }));
            this.$('#ad-markline-type-'+this.item_id).on("change", this.wrap(function(){
