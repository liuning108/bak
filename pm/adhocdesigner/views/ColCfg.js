        ...
        return portal.CommonView.extend({
            ...
            contentReady: function() {
                ...
                for(var i=0; i<this.colList.length; i++){
                    ...
                    if(col.name.indexOf('DIM_')!=-1) {// 维度
                        ...
                        + '<option value="desc">Descending</option></select></td></tr>';
                    }else{
                ...
                if(this.sortType!=''){
                    this.$('#ad-colcfg-sortselect-'+this.sortCol).val(this.sortType);
                }
            },
            ...
            fnOK: function() {
                ...
                for(var i=0; i<this.$("[name='ad-colcfg-sortselect']").length; i++){
                    ...
                    sortType = selectObj.value;
                    if(sortType!=""){
                        sortCol = selectObj.id.substring(21);
                        break;
                    }
                };
                //
