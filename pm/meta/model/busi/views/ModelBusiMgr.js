portal.define([
	'text!oss_core/pm/meta/model/busi/templates/ModelBusiMgr.html',
	'text!oss_core/pm/meta/model/busi/templates/ModelBusiBase.html',
	'text!oss_core/pm/meta/model/busi/templates/ModelBusiField.html',
	'i18n!oss_core/pm/meta/model/busi/i18n/model.busi',
	...
	return portal.BaseView.extend({
		...
		batchField:function(datas){
			...
			fish.popupView({
				url: "oss_core/pm/meta/model/busi/views/ModelBusiBatchMgr",
				viewOption: options,
		...
		showBlockUI: function(show){
			if(show){
				this.$(".js-model-busi-left-panel").blockUI({baseZ:1}).data('blockui-content', true);
	        }else{
