portal.define([
	...
	'i18n!oss_core/pm/meta/measure/i18n/measure',
	...
	return portal.BaseView.extend({
		...
		batchField:function(datas){
			...
			fish.popupView({
				url: "oss_core/pm/meta/measure/views/MeasureBatchMgr",
				viewOption: options,
		...
		ok: function() {
			if (this.$form.isValid()) {
				...
				value["fileNamePlugin"] = {"OPER_TYPE":(this.FILENAME_RULE?'edit':'add'),"CODE_PREFIX":this.codePrefix,"PLUGIN_TYPE":'03',"PLUGIN_CLASSPATH":value["FILENAME_RULE_CLASSPATH"],"BP_ID":this.bpId};
				...
				value["procRulePlugin"] = {"OPER_TYPE":(this.PROC_RULE?'edit':'add'),"CODE_PREFIX":this.codePrefix,"PLUGIN_TYPE":'04',"PLUGIN_CLASSPATH":value["PROC_RULE_CLASSPATH"],"BP_ID":this.bpId};
		...
		showBlockUI: function(show){
			if(show){
				this.$(".js-measure-left-panel").blockUI({baseZ:1}).data('blockui-content', true);
	        }else{
