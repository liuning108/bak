portal.define([
	...
	return portal.BaseView.extend({
		...
		afterRender: function(){
			...
			this.moObj = {};
			this.moList = [];
			$(".js-mo-list-ul").slimscroll({height:272});
			$(".js-mo-list-seling-item").slimscroll({height:245});
		...
		getAdapterInfo: function(){
			...
			var param = {"ADAPTER_NO":this.datas.ADAPTER_NO,"PLUGIN_NO":this.datas.PLUGIN_NO,"PLUGIN_TYPE":"00"};
		...
		showBlockUI: function(show){ 
			if(show){
				...
				this.$(".js-adapter-map-detail").blockUI({baseZ:1}).data('blockui-content', true);
