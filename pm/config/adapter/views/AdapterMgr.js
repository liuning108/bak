portal.define([
	'text!oss_core/pm/config/adapter/templates/AdapterMgr.html',
	'i18n!oss_core/pm/config/adapter/i18n/adapter',
	...
	return portal.BaseView.extend({
		...
		resize: function(delta){
			this.catTree.jqGrid("setGridHeight",this.$(".js-adapter-left-panel").height() - this.$(".js-adapter-left-panel-h3").height()-35);
			this.adapterGrid.jqGrid("setGridHeight",this.$(".js-adapter-left-panel").height() - this.$(".js-adapter-left-panel-h3").height()-70);
		...
		showDetailModal: function(operType,rowdata){
			...
			fish.popupView({
				url: "oss_core/pm/config/adapter/views/AdapterDetail",
				viewOption: options,
