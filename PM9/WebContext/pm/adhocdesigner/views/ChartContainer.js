...
define([
        ...
        "oss_core/pm/adhocdesigner/assets/js/pivot",
        "oss_core/pm/adhocdesigner/assets/js/echarts-wordcloud.min",
        'css!oss_core/pm/adhocdesigner/assets/js/pivot.css'
    ],
    ...
    return portal.BaseView.extend({
        ...
        getScatterMapOption: function () {
            ...
            $.getJSON("oss_core/pm/adhocdesigner/assets/js/mapData/geoJson/"+mapUrl, this.wrap(function(data) {
                ...
                this.chart = echarts3.init(this.$("#ad-chart-container-map")[0]);
