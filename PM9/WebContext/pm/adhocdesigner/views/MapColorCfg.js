 ...
 */
define([
        'text!oss_core/pm/adhocdesigner/templates/MapColorCfg.html',
    ...
    function(MapColorView, i18nData, adhocUtil) {
        return portal.CommonView.extend({
            ...
            contentReady: function() {
                ...
                this.$("#ad-mapcolorcfg-color-from").on("move.colorpicker", this.wrap(function(e, color) {
                ...
                this.$("#ad-mapcolorcfg-color-to").on("move.colorpicker", this.wrap(function(e, color) {
