portal.define([
	...
	return portal.BaseView.extend({
		...
		afterRender: function(){
			...
			if(this.orderData){
				fish.forEach(this.orderData['condition'],function(order,index){
					...
					$(group).find("[name='MODEL_FIELD']").combobox('value',order['field']);
					$(group).find("[name='DESC_ASC']").combobox('value',order['desc_asc']);
