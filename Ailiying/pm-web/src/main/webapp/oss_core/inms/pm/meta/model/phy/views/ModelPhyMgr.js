define([
	'text!oss_core/inms/pm/meta/model/phy/templates/ModelPhyMgr.html',
	'text!oss_core/inms/pm/meta/model/phy/templates/ModelPhyDetail.html',
	'i18n!oss_core/inms/pm/meta/model/phy/i18n/model.phy',
	...
	return fish.View.extend({
		...
		events: {
			...
			"click .js-phy-search":'search',
			"click .js-phy-reset":'reset',
		},
		...
		*/
		...
		addBatchModel: function(data) {
			...
			fish.popupView({
				url: "oss_core/inms/pm/meta/model/views/ModelBatchAdd",
				viewOption: options,
		...
		search:function(){
			...
			var ModelVal = $.trim(this.$(".js-phy-search-input").val());
