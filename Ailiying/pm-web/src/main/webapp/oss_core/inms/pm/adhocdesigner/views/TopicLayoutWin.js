 ...
 */
define([
        'text!oss_core/inms/pm/adhocdesigner/templates/TopicLayoutWin.html',
        ...
        return fish.View.extend({
            ...
            reloadChartOrderGrid: function (sortable) {
                ...
                if(this.chartOrderList.length>0 && this.layout_type=="1"){
                    ...
                    fish.forEach(self.chartList, function(chart){
                        var isExist = false;
                        fish.forEach(gridData, function(gridItem){
                    ...
                    self.$("#ad-topiclayout-chartorder").jqGrid('reloadData', gridData);
                }
            },
