 ...
 */
define([
        'text!oss_core/inms/pm/adhocdesigner/templates/AxisCfg.html',
    ...
    function(RuleMgrView, i18nData) {
        return fish.View.extend({
            ...
            contentReady: function() {
                that = this;
                this.$('#ad-axiscfg-dim-container')[0].parentElement.parentElement.parentElement.parentElement.className += " ad-axiscfg-modal-body";
