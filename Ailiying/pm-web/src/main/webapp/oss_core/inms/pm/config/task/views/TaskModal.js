define([
	'text!oss_core/inms/pm/config/task/templates/TaskModal.html',
	'text!oss_core/inms/pm/config/task/templates/BaseInfo.html',
	...
	return portal.BaseView.extend({
		...
		render: function() {
			...
			require(['oss_core/inms/pm/util/views/ScheduleView'],
				function(schedule){
		...
		afterRender: function(){
			...
			this.$form.find("[name='TASK_TYPE']").on('combobox:change', function () {
				...
				var detailUrl;
				if(taskType=='00'){//采集任务
					detailUrl = 'oss_core/inms/pm/config/task/views/CollectDetail';
				}else if(taskType=='01'){//计算任务
					detailUrl = 'oss_core/inms/pm/config/task/views/ComputeDetail';
				}else if(taskType=='03'){//告警任务
					detailUrl = 'oss_core/inms/pm/config/task/views/AlarmDetail';
				}else if(taskType=='02'){//数据汇聚
					detailUrl = 'oss_core/inms/pm/config/task/views/AggDetail';
				}else if(taskType=='05'){//数据抽取
					detailUrl = 'oss_core/inms/pm/config/task/views/ExtDetail';
				}else if(taskType=='06'){//其他任务
					detailUrl = 'oss_core/inms/pm/config/task/views/OtherDetail';
				}
