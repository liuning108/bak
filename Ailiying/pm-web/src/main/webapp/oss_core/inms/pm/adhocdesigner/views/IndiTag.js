 ...
 */
define([
        'text!oss_core/inms/pm/adhocdesigner/templates/IndiTag.html',
    ...
    function(mainTpl, echarts, i18nData, Draggabilly) {
        return portal.BaseView.extend({
            ...
            showIndiSetup: function () {
                var self = this;
                require([
                    'oss_core/inms/pm/adhocdesigner/views/IndiSetup'
                ], function (Dialog) {
                    var sData = self.formatObj;
                    ...
                    self.indiSetUpView = fish.popup(option);
                    dialog.afterRender();
