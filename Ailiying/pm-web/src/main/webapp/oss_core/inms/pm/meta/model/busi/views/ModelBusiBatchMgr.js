define([
	'text!oss_core/inms/pm/meta/model/busi/templates/ModelBusiBatchMgr.html'
],function(modelBatchAddTpl){
	return fish.View.extend({
		template: fish.compile(modelBatchAddTpl),
		events: {
			"click .js-ok": 'ok'
		},
		initialize: function(options) {
			this.i18nData =	options.i18nData;
			this.modelAction = options.modelAction;
		...
		afterRender: function(){
			var that = this;
			var $grid = this.$(".js-model-busi-batch-grid");
			this.batchGrid = $grid.jqGrid({
				...
				afterEditRow: function (e, rowid, data, option) {
					...
					$("#" + rowid+"_EFF_TIME", ".js-model-busi-batch-grid").datetimepicker({
		                buttonIcon: '',
		                viewType: 'date',
			...
			$(".js-model-busi-batch-form textarea").css("height","300");
			$(".js-model-busi-batch-form textarea").attr("wrap","off");
			$(".js-model-busi-batch-form textarea").addClass("form-control");
