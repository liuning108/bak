 ...
 */
define([
        'text!oss_core/inms/pm/meta/datalifetime/templates/DataLifeTimeMgr.html',
        'oss_core/inms/pm/adhocdesigner/actions/AdhocAction',
        'oss_core/inms/pm/meta/datalifetime/actions/DataLifeTimeAction',
        'oss_core/inms/pm/meta/datalifetime/views/DataLifeTimePopWin',
        ...
        'css!oss_core/inms/pm/meta/datalifetime/assets/datalifetime.css'
    ],
