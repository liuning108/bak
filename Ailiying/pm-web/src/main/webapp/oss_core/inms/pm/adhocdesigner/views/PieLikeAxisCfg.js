 ...
 */
define([
        'text!oss_core/inms/pm/adhocdesigner/templates/PieLikeAxisCfg.html',
        'i18n!oss_core/inms/pm/adhocdesigner/i18n/adhoc',
        'oss_core/inms/pm/adhocdesigner/views/PieLikeAxisGroup'
    ],
    function(RuleMgrView, i18nData, axisCfgGroup) {
        return fish.View.extend({
            ...
            contentReady: function() {
                var self = this;
                this.$('#ad-axisgroup-plus').on("click", function(){
                    self.addAxisGroup({
                        GROUP_TITLE: '',
                        DIM_NO: '',
                        KPI_NO: ''
            ...
            addAxisGroup: function(group) {
                ...
                this.listenTo(axisGroup, 'groupClose', function (data) {
                    self.groupClose(data.group_id);
                });
            ...
            fnOK: function() {
                ...
                for(var i=0; i<this.groupCompList.length; i++){
                    ...
                    tmpGroupList[tmpGroupList.length] = {
                        ...
                        "PIECHART_TYPE": axisGroup.pieChartType
                    };
                }
