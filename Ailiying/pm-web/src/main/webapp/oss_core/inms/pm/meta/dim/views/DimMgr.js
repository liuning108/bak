define([
	'text!oss_core/inms/pm/meta/dim/templates/DimMgr.html',
	'text!oss_core/inms/pm/meta/dim/templates/DimDetail.html',
	'i18n!oss_core/inms/pm/meta/dim/i18n/dim',
	...
	return fish.View.extend({
		...
		addBatchDim: function(data) {
			...
			fish.popupView({
				url: "oss_core/inms/pm/meta/dim/views/DimBatchAdd",
				viewOption: options,
