...
import com.ztesoft.zsmart.oss.inms.pm.common.exception.ExceptionConstants;
...
public final class CommonUtil {
    ...
    public static String getStrFromMapWithExc(Map map, String key) throws BaseAppException {
        Object obj = map.get(key);
        if (null == obj) {
            ExceptionHandler.publish(ExceptionConstants.PM_COMMON_CODE_NOT_EXISTS, "NO " + key, key);
        }
