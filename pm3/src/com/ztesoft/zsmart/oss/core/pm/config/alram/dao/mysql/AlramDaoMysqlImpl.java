 ...
 ****************************************************************************************/
package com.ztesoft.zsmart.oss.core.pm.config.alram.dao.mysql;
...
public class AlramDaoMysqlImpl extends AlramDao {
    ...
    public Map<String, Object> queryAlramList(Map<String, String> param) throws BaseAppException {
        ...
        String sql = ""
            + "select b.alarm_name, COUNT(a.warn_instid) warn_times,B.ALARM_LEVEL,B.COLOR from PM_WARN_INST a right join pmp_dim_alarmlevel b "
            + "on a.WARN_LEVEL = b.alarm_level "+setTime(time,"")
        ...
        long  end = page*nums;
        String sqlPage  =AlramUtil.getPageMysqlSql(sql2, start, end);
