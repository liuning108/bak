...
public class KnowledgeMgr extends AbstractKnowledgeMgr {
     ...
     */ 
    @Override
    public String addAttach(String id, String filePath, String fileName, String state, String type,String userId) throws BaseAppException {
        // TODO Auto-generated method stub <br>
        KnowledgeDao dao = (KnowledgeDao) GeneralDAOFactory.create(KnowledgeDao.class, JdbcUtil.getDbIdentifier(JdbcUtil.OSS_PM));
        return dao.addAttach(id,filePath,fileName,state,type,userId);
    }
    ...
    public List<HashMap<String, String>> queryAttachByDocId(String docId) throws BaseAppException {
         ...
         KnowledgeDao dao = (KnowledgeDao) GeneralDAOFactory.create(KnowledgeDao.class, JdbcUtil.getDbIdentifier(JdbcUtil.OSS_PM));
         return  dao.queryAttachByDocId(docId);
    }
