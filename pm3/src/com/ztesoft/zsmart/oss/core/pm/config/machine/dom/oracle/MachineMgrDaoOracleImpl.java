package com.ztesoft.zsmart.oss.core.pm.config.machine.dom.oracle;
 ...
 */
public class MachineMgrDaoOracleImpl extends MachineMgrDao {
	...
	public void qryCollectMachines(DynamicDict dict) throws BaseAppException {
	        ...
	        String sql ="SELECT MACHINE_NO, SEQ, MACHINE_NAME, MACHINE_USER, MACHINE_IP, STATE, NOTES,REMAIN FROM PM_COLLECT_MACHINE ORDER BY REMAIN DESC";
	...
	public  void saveOrUpdateCollectMachineTask(DynamicDict collectMechineDic, List<String> task_nos)  throws BaseAppException{
		...
		String sql="DELETE FROM PM_COLLECT_MACHINE_TASK CT WHERE CT.MACHINE_NO=?";
		pa.set("", no);
		this.executeUpdate(sql, pa);
		//添加最新的
		String addSql=
				"INSERT INTO PM_COLLECT_MACHINE_TASK " +
						"  (MACHINE_NO, SEQ, COLLECT_TASKNO) " + 
						"VALUES " + 
						"  (?, 0, ?) ";
	...
	public String saveCollectMachine(DynamicDict dict) throws BaseAppException {
		...
		String sql=
				"INSERT INTO PM_COLLECT_MACHINE " +
						"  (MACHINE_NO, SEQ, MACHINE_NAME, MACHINE_USER, MACHINE_IP, STATE, NOTES,REMAIN) " + 
						"VALUES " + 
						"  (?,0, ?, ?, ?, 1,?,?)";
		pa.set("", no);
	...
	public boolean updateCollectMachine(DynamicDict dict) throws BaseAppException {
        ...
        return this.executeUpdate(sql, pa)>0?true:false;
	}
	...
	public void deleteCollectMachine(DynamicDict dict) throws BaseAppException {
		...
		//删除采集机
		 ...
		 String sql="DELETE FROM PM_COLLECT_MACHINE CM WHERE CM.MACHINE_NO=?";
		 pa.set("", no);
		 this.executeUpdate(sql, pa); 
	}
	...
	public void queryUndistbutedTask(DynamicDict dict) throws BaseAppException {
		...
		String sql="SELECT INFO.TASK_NO,INFO.TASK_NAME FROM PM_TASK_INFO INFO " +
				   "WHERE NOT EXISTS( SELECT 'X' FROM PM_COLLECT_MACHINE_TASK CT WHERE CT.COLLECT_TASKNO=INFO.TASK_NO)";
