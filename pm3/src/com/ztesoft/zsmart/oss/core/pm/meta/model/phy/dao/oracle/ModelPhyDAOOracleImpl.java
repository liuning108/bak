package com.ztesoft.zsmart.oss.core.pm.meta.model.phy.dao.oracle;
...
/**
 * 
 * PM元数据-物理模型管理相关的Oracle DAO操作实现类 <br> 
 *  
 * @author Srd <br>
 * @version V8.0.1<br>
 * @CreateDate 2017-4-10 <br>
 * @since JDK7.0<br>
 * @see com.ztesoft.zsmart.oss.core.pm.meta.model.phy.dao.oracle <br>
 */
public class ModelPhyDAOOracleImpl extends ModelPhyDAO {
    /**
     * sql
     */
    String sql = "";
