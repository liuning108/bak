package com.ztesoft.zsmart.oss.core.pm.meta.model.busi.dao.mysql;
...
public class ModelBusiDAOMysqlImpl extends ModelBusiDAO {
    ...
    public void getModelBusiInfo(DynamicDict dict) throws BaseAppException {
        ...
        sql = "select b.ems_code,   \n" 
            ...
            + "       b.model_phy_name,    \n" 
            + "       a.model_phy_code,    \n"
            + "       concat_ws('', b.model_phy_name, '(', a.model_phy_code, ')') as model_phy,    \n" 
            + "       b.granu_mode,    \n"
            + "       b.model_type,    \n" 
    ...
    public void getModelBusiField(DynamicDict dict) throws BaseAppException {
        ...
        if ("ALL".equals(mode) || "DISTINCT".equals(mode)) {
            ...
            String distinct_kpi = " select distinct t.field_type,    \n" 
                ...
                + "                  k.ems_type_rel_id        \n" 
                + "    from ("
                + model_busi_detail.toString() + ") t, pm_kpi k    \n" 
