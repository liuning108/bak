package com.ztesoft.zsmart.oss.core.pm.report.collect.dao.mysql;
 ...
 */
public class CollectDAOMysqlImpl extends CollectDAO {
    /**
     * sql
     */
    String sql = "";
    ...
    public void getCollectInfo(DynamicDict dict) throws BaseAppException {
        ...
        if("ems".equals(flag)){ //distinct EMS下的ftp信息
            ...
            sql =
                ...
                +"  from pm_ems a, pm_ems_type_rel b left join    \n"
                ...
                +" )   c on b.ems_type_rel_id=c.ems_type_rel_id  \n"
