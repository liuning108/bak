package com.ztesoft.zsmart.oss.core.pm.counter.dao.oracle;
...
public class CounterDAOOracleImpl extends CounterDAO {
    ...
    public void getCounterData(DynamicDict dict) throws BaseAppException {
        ...
        sql = "select upper(a.column_name) as column_name                        \n"
            ...
            + "          from pm_cntqry_modisp a, pm_cntqry_modisp_detail b      \n"
            + "         where a.mo_code = ?                                      \n"
            + "           and a.template_no = b.template_no) y                   \n"
            + " where a.table_name = ?                                           \n"
            + "   and a.column_name = x.field_code(+)                            \n"
            + "   and a.column_name = y.cnt_phy_col(+)                           \n"
