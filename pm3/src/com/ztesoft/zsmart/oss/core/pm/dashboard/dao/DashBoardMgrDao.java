...
public abstract class DashBoardMgrDao extends GeneralDAO<Object> {
    ...
    */
     ...
     * @return <br>
     */ 
    public abstract Map<String, String> delDashBoardById(Map<String, String> param) throws BaseAppException;
     ...
     * @return <br>
     */ 
    public abstract Map<String, Object> addExportTask(Map<String, Object> param) throws BaseAppException;
     ...
     * @return <br>
     */ 
    public  abstract Map<String, Object> getExportTaskListByUserId(Map<String, String> param) throws BaseAppException;
     ...
     * @return <br>
     */ 
    public abstract Map<String, Object> getExportTaskListByUserIdAndFilter(Map<String, String> param)   throws BaseAppException;
