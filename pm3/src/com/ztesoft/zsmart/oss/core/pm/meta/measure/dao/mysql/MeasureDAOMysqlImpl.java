package com.ztesoft.zsmart.oss.core.pm.meta.measure.dao.mysql;
...
/**
 * PM元数据-测量对象管理相关的Mysql DAO操作实现类 <br>
 * 
 * @author Srd <br>
 * @version V8.0.1<br>
 * @CreateDate 2017-4-7 <br>
 * @since JDK7.0<br>
 * @see com.ztesoft.zsmart.oss.core.pm.meta.measure.dao.mysql <br>
 */
public class MeasureDAOMysqlImpl extends MeasureDAO {
    ...
    public void getMeasureField(DynamicDict dict) throws BaseAppException {
        ...
        String fieldCode = (String) dict.getValueByName("FIELD_CODE", "");
        String fieldCodes = (String) dict.getValueByName("FIELD_CODES", "");
        ...
        sql = "select a.mo_code,        \n" + "       a.field_name,    \n" + "       a.field_code,    \n"
            ...
            + tool.ternaryExpression("".equals(moCodes), "", " and a.mo_code in (" + moCodes + ")   \n")
            + tool.ternaryExpression("".equals(fieldName), "", " and upper(a.field_name) like upper('%'||?||'%')   \n")
            + tool.ternaryExpression("".equals(fieldCode), "", " and a.field_code = ?   \n")
            + tool.ternaryExpression("".equals(fieldCodes), "", " and a.field_code in (" + fieldCodes + ")   \n")
