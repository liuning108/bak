...
public class KPIRELADAOOracleImpl extends KPIRELADAO {
    ...
    public void getKPIRELAInfo(DynamicDict dict) throws BaseAppException {
        ...
        for (int i = 0; i < molistDict.getCountByName("MO_NO"); i++) {
            ...
            for (int i1 = 0; i1 < count; i1++) {
                ...
                singlecounterDict.setValueByName("NAME",
                        counterMap.get("FIELD_CODE"));
                singlecounterDict.setValueByName("NO",
                        counterMap.get("FIELD_NO"));
                reCounterListDict.setValueByName("COUNTER", singlecounterDict,
                        1);
            }
        ...
        DynamicDict modellistDict = (DynamicDict) dict.getValueByName(
                "MODEL_LIST", null);
        if (null == modellistDict) {
            ExceptionHandler
                    .publish("R8-PM-META-100102", "MODEL_LIST is empty");
        }

        // 首先得到所有KPI字段
        String strColumn = "";
        for (int j = 0; j < modellistDict.getCountByName("BUSINESS_MODEL"); j++) {
            String strmodel = (String) modellistDict.getValueByName(
                    "BUSINESS_MODEL", j);
            ...
            listColumn = getColumnNameBySql(Strscript);
            ...
            if (stmt instanceof Select) {
                ...
                if (stmt instanceof CreateTable) {
                    ...
                    for (int i = 0; i < listcolumn.size(); i++) {
                        ...
                        list.add(columnDef.getColumnName());
                    }
                }
        }
    ...
    public void getMOPluginInfo(DynamicDict dict) throws BaseAppException {
        // TODO Auto-generated method stub
        DynamicDict molistDict = (DynamicDict) dict.getValueByName("MO_LIST",
                null);
        if (null == molistDict) {
            ExceptionHandler.publish("R8-PM-META-100101", "MO_LIST is empty");
        }
        ...
        for (int i = 0; i < molistDict.getCountByName("MO_NO"); i++) {
            ...
            // 根据MO_NO获取PLUGIN
            String sqlplugin = " select a.mo_code,b.plugin_classpath,b.plugin_no from pm_mo a, pm_pluginserv b "
                    + " where 1 = 1 \n"
            ...
            List<HashMap<String, String>> rListPlugin = queryList(sqlplugin,
                    paramsMO);
            ...
            for (int i1 = 0; i1 < pluginCount; i1++) {
                ...
                str_plugin_classpath = (String) pluginMap
                        .get("PLUGIN_CLASSPATH");
            ...
            List<HashMap<String, String>> rListParam = queryList(sqlparam,
                    params);
            ...
            for (int j = 0; j < paramCount; j++) {
                ...
                singleParamDict.setValueByName("PLUGIN_TYPE",
                        paramMap.get("PLUGIN_TYPE"));
                singleParamDict.setValueByName("PARAM_CODE",
                        paramMap.get("PARAM_CODE"));
                singleParamDict.setValueByName("PARAM_NAME",
                        paramMap.get("PARAM_NAME"));
                singleParamDict.setValueByName("PARAM_VALUE",
                        paramMap.get("PARAM_VALUE"));
