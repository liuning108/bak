define([
    "oss_core/pm/screendesigner/js/graphLibs/GRoot", "oss_core/pm/screendesigner/js/graphLibs/views/GArcProcessView"
], function(GRoot, View) {
    ...
    var GArcProcess = GRoot.extend({
        ...
        initElement: function() {
            ...
            this.doms['title'] = this.paper.text(center_x, center_y, title).attr({'fill': titleColor, 'font-size': 22, 'font-family': '微软雅黑', 'font-weight': 'bold'});;
            ...
            this.doms['config'] = this.paper.text(center_x - 60, center_y + 40, '配置').attr({'fill': 'red', 'font-size': 18, 'font-family': '微软雅黑', 'font-weight': 'bold'});;
            this.doms['remove'] = this.paper.text(center_x, center_y + 40, 'X').attr({'fill': 'red', 'font-size': 20, 'font-family': '微软雅黑', 'font-weight': 'bold'});;
            self.setTitle(title);
