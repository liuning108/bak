/**
 * 第三方组件，滚动加载更多
 * @class fish.desktop.widget.infitscroll
 * @author zhang.wei
 * @since V3.13.0
 */
    ...
    $.widget('ui.infinitescroll', {
        ...
        _delegateEvents: function() {
            ...
            this._on(this.element,{
                'scroll': fish.throttle(function(e){
                ...
                },this.options.scrollThrottle,{leading:false})
            });
        },
        ...
        resetLoad: function() {
            ...
            this._scrollContentHeight = this.element[0].scrollHeight;
            if (!this.isEmpty) {
                if (this._scrollContentHeight <= this._scrollWindowHeight) {
                    this._loadDown();
                }
            } else {
