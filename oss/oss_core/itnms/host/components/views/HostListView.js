        ...
        colModel: [
          {
            ...
            formatter: function(cellval, opts, rwdat, _act) {
              if (cellval === 0) {
                return "<div class='kdo-on-off-icon'><img width='16' height='16' src='static/oss_core/itnms/host/images/right.png'></img><span>启用</span></div>"
              } else {
                return "<div class='kdo-on-off-icon'><img width='16' height='16' src='static/oss_core/itnms/host/images/error.png'></img><span>禁用</span></div>"
              }
            }
          }, {
            name: 'available',
