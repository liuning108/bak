define([
    ...
    var TypeMapping = {
        ...
        'MapBase':'oss_core/pm/screendesigner/js/graphLibs/mapBase/MapBase',
        'MapSplashes':'oss_core/pm/screendesigner/js/graphLibs/mapBase/MapSplashes',
    };
    var uuid = function() {
        var s = [];
    ...
    var ZChartCanvas = Class.extend({
        ...
        setViewBox: function(w, h) {
            ...
            if(self.w<$(self.dom).width()){
                $(self.dom).width(self.w)
            }
            var d_w = $(self.dom).width();
            var sf = self.h/ self.w ;
            var h = sf * d_w;
