 ...
 */
define([
        'text!oss_core/pm/adhocdesigner/templates/ShareTopicViewWin.html',
    ...
    function(ShareTopicView, action, i18nData) {
        return portal.CommonView.extend({
            ...
            loadTopicGrid: function () {
                var self = this;
                action.loadSharedTopicList({"OPER_USER": this.userId}, function(data){
                    var gridData = [];
                    fish.forEach(data.sharedTopicList, function(topic){
