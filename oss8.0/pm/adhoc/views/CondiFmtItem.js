 ...
 */
define([
        'text!oss_core/pm/adhocdesigner/templates/CondiFmtItem.html',
    ...
    return portal.BaseView.extend({
        ...
        render: function () {
            this.$el.html(this.reportMainTemplate(fish.extend({item_id: this.item_id})));
            return this;
        },

        afterRender: function () {
            //
            this.$('#ad-condifmtitem-plus').on("click", this.wrap(function(){
                this.addCondifmtItem();
            }));
            this.$('#ad-condifmtitem-minus').on("click", this.wrap(function(){
                this.delCondifmtItem();
            }));
            this.$('#ad-fmtsel-'+this.item_id).on("change", this.wrap(function(){
                this.fmtselChange();
            }));
            //
