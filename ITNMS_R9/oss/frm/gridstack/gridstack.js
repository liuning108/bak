...
(function(factory) {
    ...
    */
    ...
    var GridStack = function(el, opts) {
        ...
        if (!self.opts.staticGrid && self.opts.acceptWidgets) {
            ...
            this.dd
                ...
                .on(self.container, 'drop:over', function(event, ui) {
                ...
                .on(self.container, 'drop:out', function(event, ui) {
                    var el = $(ui.draggable);
    ...
    GridStack.prototype._updateContainerHeight = function() {
        ...
        //调整容器与屏幕边缘的距离
        this.container.css('margin', '-6px -8px 0 -8px');
    };
    ...
    GridStack.prototype._prepareElementsByNode = function(el, node) {
        ...
        var onEndMoving = function(event, ui) {
            ...
            if (nestedGrids.length && event.type == 'resize:stop') {
