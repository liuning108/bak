define([
	...
	'text!modules/portletmgr/templates/PortletMenuCusGrant.html',
...
//		templateDRHalf: fish.compile(""),
		...
		initialize: function(initData) {
			...
			fish.extend(this.i18nData, {
				privName: this.selectedPortlet.privName
			});
