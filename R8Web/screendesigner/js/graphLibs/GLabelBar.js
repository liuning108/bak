define([
    "oss_core/pm/screendesigner/js/graphLibs/GRoot", "oss_core/pm/screendesigner/js/graphLibs/views/GLabelBarView"
], function(GRoot, View) {
    ...
    var GLabelBar = GRoot.extend({
        ...
        initElement: function() {
            ...
            this.colors =this.attrs.colors|| ['#5a9bd5', '#01d15e', '#ffc101', '#e97870']
            this.attrs.colors=this.colors;
            ...
            var max = Math.floor(1.1 * fish.max(this.attrs.datas));
             ...
             var maxW= this.getMaxWidthName(this.names)
            for (var i = 0; i < this.names.length; i++) {
                ...
                var item = self.createItem(i, x, y, name, color, per, value,maxW);
            ...
            this.doms['remove'] = this.paper.text(0, -30, 'X').attr({'fill': 'red', 'font-size': 20, 'font-family': '微软雅黑', 'font-weight': 'bold'});;
        ...
        createItem: function(index, x, y, name, color, per, value,maxW) {
            var self = this;
            var paper = this.paper;
            var set = paper.set();
            var item = {};
