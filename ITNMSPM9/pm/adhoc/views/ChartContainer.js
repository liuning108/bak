...
define([
        ...
        "oss_core/pm/adhocdesigner/assets/js/echarts3",
    ...
    return portal.BaseView.extend({
        ...
        getPieChartOption:  function (param, groupIndex) {
            ...
            if(this.pieChartType=="1"){
                this.option.series[0].radius = ['20%', '55%'];
            }
            return this.option;
        },
            ...
            fish.forEach(this.simuDp, this.wrap(function(data){
                fish.forEach(this.selectedDimIndiList, this.wrap(function(kpiCfgObj){
                    if(kpiCfgObj.COL_TYPE=="01"){
                        ...
                        if((kpiCfgObj.isThousandDisplay=="true" || kpiCfgObj.isThousandDisplay) && this.chart_type=="grid"){
        ...
        bindExtendAnalysis: function (chart) {
            ...
            if(this.isExtendedAnalysis){
                chart.on('click', this.wrap(function (params) {
        ...
        getScatterMapOption: function () {
            ...
            if(this.axisCfgYaxisList.length==0 || this.axisCfgXaxis == "") {
                fish.forEach(this.colModel, this.wrap(function (col) {
                    if (col.colType == 1 && this.axisCfgYaxisList.length == 0) {
                        this.axisCfgYaxisList[this.axisCfgYaxisList.length] = col.name;
                    } else if (this.axisCfgXaxis == "") {
                        this.axisCfgXaxis = col.name;
                    }
            ...
            $.getJSON("oss_core/pm/adhocdesigner/assets/js/mapData/geoJson/"+mapUrl, this.wrap(function(data) {
                echarts3.registerMap(this.AREAMAP_URL, data);
                console.log('registerMap:'+this.AREAMAP_URL);
                self.mapDataList = [];
                var featureCount = 0;
                ...
                var option = {
                    ...
                    legend: {
                        ...
                        orient : (this.mapLegendDirection.split("-"))[0],
                        x : (this.mapLegendDirection.split("-"))[1],
                        y : (this.mapLegendDirection.split("-"))[2],
                        data:[kpiName]
                    },
                    dataRange: {
                        min: 0,
                    ...
                    series : [
                        {
                            ...
                            symbol: this.labelSymbol, //'circle', 'rectangle', 'triangle', 'diamond'
                            symbolSize: this.labelSize,
                ...
                this.chart = echarts3.init(this.$("#ad-chart-container-"+this.chart_id)[0]);
