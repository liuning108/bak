...
define([
    ...
    return portal.BaseView.extend({
        ...
        initialize: function (opt) {
            /*
            this.websocket = new WebSocket("ws://localhost:7397/ws");
            //websocket.send("111");
            ...
            this.cacheMetaData = action.cacheModelData({}, this.wrap(function (data) {
                ...
                for(var i=0;i<data.modelField.length;i++){
                    ...
                    if(FIELD_TYPE=="0"){
                        ...
                        this.cachedDim.put(modelObj.MODEL_CODE + "-" + FIELD_CODE, FIELD_NAME);
                        ...
                        this.cachedIndi.put(modelObj.MODEL_CODE + "-" + FIELD_CODE, FIELD_NAME);
                    }
                }
                ...
                for(var i=0; i<topicList.length; i++) {
                    ...
                    for(var j=0; j<this.dimAndIndiList.length; j++){
                        ...
                        if(dimIndiObj.TOPIC_NO == topic.TOPIC_NO && (dimIndiObj.COL_TYPE=='00' || dimIndiObj.COL_TYPE=='02')){
                            var dim_name = this.cachedDim.get(topic.MODEL_CODE+"-"+dimIndiObj.COL_NO);
