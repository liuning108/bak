define([
    "oss_core/pm/screendesigner/js/graphLibs/GRoot",
     "oss_core/pm/screendesigner/js/raphael-areaLineBar", "oss_core/pm/screendesigner/js/graphLibs/views/GBarView"
    ...
    var GBar = GRoot.extend({
        ...
        initElement: function() {
            ...
            var topBox =this.doms['rect'].getBBox(true);
            this.attrs.title = this.attrs.title||'';
            this.doms['title'] = this.paper.text(topBox.x + topBox.width/2, y - 140, this.attrs.title).attr({'fill': this.attrs.titleColor, 'font-size': 24, 'font-family': '微软雅黑', 'font-weight': 'bold'});
