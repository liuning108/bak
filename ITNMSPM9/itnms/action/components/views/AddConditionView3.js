define([
    ...
    "text!oss_core/itnms/action/components/views/addConditionView3.html",
...
], function(action,tpl,i18nData,AddGroupView,AddHostView,AddTemView) {
    ...
    AddConditionView.prototype.renderCombox = function() {
        var self = this;
        action.itemTypes('ACTION_CONDITION_OPERATOR_0,ACTION_CONDITION_OPERATOR_1,ACTION_CONDITION_OPERATOR_2,ACTION_CONDITION_OPERATOR_3,ACTION_CONDITION_OPERATOR_4,ACTION_CONDITION_OPERATOR_6,ACTION_CONDITION_OPERATOR_13,ACTION_CONDITION_TYPE_16,ACTION_CONDITION_OPERATOR_25,ACTION_CONDITION_OPERATOR_26,TRIGGER_SEVERITY_LEVEL,ACTION_CONDITION_OPERATOR_23,ACTION_INTERNAL_EVENT_TYPE').then(function(datas){
            ...
            self.$eventIleType = self.$el.find('.eventIleType').combobox({
                editable: false,
                dataTextField: 'paraName',
                dataValueField: 'paraValue',
                dataSource: datas.ACTION_INTERNAL_EVENT_TYPE
            });
            self.$eventIleType.combobox('value',datas.ACTION_INTERNAL_EVENT_TYPE[0].paraValue)
            self.$con23 = self.$el.find('#conD23').combobox({
                editable: false,
                dataTextField: 'paraName',
                dataValueField: 'paraValue',
                dataSource: datas.ACTION_CONDITION_OPERATOR_23
            });
            self.$con23.combobox('value',datas.ACTION_CONDITION_OPERATOR_23[0].paraValue)
